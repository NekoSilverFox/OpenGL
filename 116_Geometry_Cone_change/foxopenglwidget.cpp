...
unsigned int drop_pos_mod = 1;
float step_angle = 90.0f;
...
//            _sp_cone.setUniformValue("material.specular",   QVector3D(0.6f, 0.6f, 0.6f));
            ...
            _sp_cone.setUniformValue("drop_pos_mod", drop_pos_mod);
...
void FoxOpenGLWidget::keyPressEvent(QKeyEvent *event)
{
    ...
    case Qt::Key_Up:    move3DShape(QVector3D( 0.0f,      moveSpeed, 0.0f)); drop_pos_mod++; break;
    case Qt::Key_Down:  move3DShape(QVector3D( 0.0f,     -moveSpeed, 0.0f)); drop_pos_mod--; break;
